...
public class TurretWedgeTrigger : MonoBehaviour
{
    [Range(0.1f, 50f)]
    ...
    private void OnDrawGizmos()
    {
        ...
        if (isSeen)
        {
            ...
            foundation.transform.LookAt(targetPos);

            barrel.transform.LookAt(targetObject.transform);
            barrel.transform.Rotate(90f, 0, 0, Space.Self);
        }
        else
        {
